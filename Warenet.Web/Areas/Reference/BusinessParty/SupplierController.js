...
define(['appconfig'], function (app) {
    ...
    function SupplierController($scope, $state, $stateParams, $timeout, $q, httpService, uiService) {
        // variables
        var vm = this;
    ...
    app.register.controller("SupplierController", SupplierController);
